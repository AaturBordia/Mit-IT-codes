...
int main() {
    ...
    strcpy(stu[0].regno, "210911340");
    strcpy(stu[1].regno, "210968192");
    strcpy(stu[0].name, "Aatur Bordia");
    strcpy(stu[1].name, "Aakash Gangurde");
    ...
    strcpy(stu[0].add, "Udaipur");
    strcpy(stu[1].add, "Vadodra");
